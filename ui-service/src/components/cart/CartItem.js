            ...
            <td className="col-sm-8 col-md-6">
                <div className="media">
                    ...
                    <div className="media-body">
                        <h4 className="media-heading"><a href="#">{cartData.productTitle}</a></h4>
                        <h5 className="media-heading"> category: <a href="#">{cartData.category.categoryTitle}</a></h5>
                    </div>
                </div></td>
            <td className="col-sm-1 col-md-1" style={{ textAlign: "center" }}>
                <input type="number" min="1" id="qty" name="qty" className="form-control" value={input} onChange={onChangeHandler} />
            </td>
            <td className="col-sm-1 col-md-1 text-center"><strong>&#2547; {cartData.productPrice}</strong></td>
